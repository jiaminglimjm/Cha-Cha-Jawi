...
const mytexts = {
    mudah: [
        ...
        "سنجات يڠ ڤاليڠ امڤوه اداله جيوا سأورڠ يڠ سدڠ درونديڠ اسمارا.",
        "چينتا يڠ دداسري دڠن کتلوسن هاتي تق اکن ڤرنه اد هابيسڽ.",
        "اد باڽق بواه تاڤي تيدق سمواڽ باٴيق. اد باڽق علمو تاڤي تيدق سمواڽ برݢونا.",
        ...
        "ايتيق ساي سوک مڠوٴيق دڠن قوات ڤد وقتو ڤاݢي.",
        "ڤق ابو ممليهارا کمبيڠ دان لمبو دلادڠ بلاکڠ رومهڽ.",
        "ڤنتاي يڠ اينده ايت سلالو دڤنوهي ڤلنچوڠ ڤد موسيم چوتي.",
    //end of easy
    ],
